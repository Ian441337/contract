...
public class RevengeContractItem extends Item {
    public RevengeContractItem(Properties properties) {
        super(properties);
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand hand) {
        ...
        if (!level.isClientSide) {
            if (!isBound(stack)) {
                ...
                player.sendSystemMessage(Component.literal("Revenge Contract bound to: " + player.getName().getString())
        ...
        if (customData != null) {
            ...
            if (tag.contains("BoundPlayer")) {
                ...
                tooltip.add(Component.literal("Bound to: " + playerName)
                        .withStyle(ChatFormatting.DARK_RED));
                tooltip.add(Component.literal("When holder dies, bound player gains Strength")
